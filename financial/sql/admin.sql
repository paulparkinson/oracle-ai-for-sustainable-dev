...
-- ADD ROLES, ak: grant DBS_CLOUD to financial to run most admin sql as financial
GRANT EXECUTE ON DBMS_CLOUD TO FINANCIAL;
GRANT EXECUTE ON DBMS_CLOUD_AI TO FINANCIAL;
GRANT EXECUTE ON DBMS_CLOUD_ADMIN TO FINANCIAL;
GRANT EXECUTE on DBMS_CLOUD_PIPELINE to FINANCIAL;
GRANT SODA_APP TO FINANCIAL;
