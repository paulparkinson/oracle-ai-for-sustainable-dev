...
final class OracleMcpToolCatalog {
  ...
  private static ToolDefinition mcpOnly(String id, String description, Map<String, String> schema) {
    return new ToolDefinition(id, description, schema, new ToolDefinition.McpExposure(true),
