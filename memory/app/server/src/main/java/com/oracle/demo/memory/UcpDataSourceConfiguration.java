...
public final class UcpDataSourceConfiguration {
    ...
    public static PoolDataSource fromEnvironment(Map<String, String> environment) {
        ...
        String username = firstNonBlank(
                firstNonBlank(environment.get("DB_USERNAME"), environment.get("DB_USER")),
                DEFAULT_USER);
        ...
        try {
            ...
            dataSource.setConnectionPoolName(environment.getOrDefault("DB_POOL_NAME", "MagicMemoryUcpPool"));
            ...
            dataSource.setInactiveConnectionTimeout(integer(
                    environment, "DB_INACTIVE_CONNECTION_SECONDS", 60, 0, 3600));
            dataSource.setValidateConnectionOnBorrow(true);
            dataSource.setConnectionProperty(
                    "oracle.jdbc.defaultRowPrefetch",
                    environment.getOrDefault("DB_ROW_PREFETCH", "50"));
            return dataSource;
